...
#define nrn_init _nrn_init__ComplexCl2g
#define _nrn_initial _nrn_initial__ComplexCl2g
#define nrn_cur _nrn_cur__ComplexCl2g
#define _nrn_current _nrn_current__ComplexCl2g
#define nrn_jacob _nrn_jacob__ComplexCl2g
#define nrn_state _nrn_state__ComplexCl2g
#define _net_receive _net_receive__ComplexCl2g 
#define state state__ComplexCl2g 
...
#define gettest gettest_ComplexCl2g
#define getnumreleased getnumreleased_ComplexCl2g
#define initthyme initthyme_ComplexCl2g
#define initves initves_ComplexCl2g
#define sumves sumves_ComplexCl2g
...
#define ca_baseline ca_baseline_ComplexCl2g
 double ca_baseline = 0.0001;
#define numves numves_ComplexCl2g
 double numves = 5;
#define regentime regentime_ComplexCl2g
 ...
 "ca_baseline_ComplexCl2g", &ca_baseline_ComplexCl2g,
 "numves_ComplexCl2g", &numves_ComplexCl2g,
 "regentime_ComplexCl2g", &regentime_ComplexCl2g,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 ComplexCl2g /home/jbhunt/Dropbox/Code/Python/lib/sacnet/sacnet/data/mechanisms/x86_64/ComplexCl2g.mod\n");
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 83 in file ComplexCl2g.mod:\n    \n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 2; ++_i) {
